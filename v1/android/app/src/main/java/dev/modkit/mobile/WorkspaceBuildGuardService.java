...
public class WorkspaceBuildGuardService extends Service {
    ...
    private void requirePreparedPatchFresh()throws IOException{if(app.file("workspace-patch-stale").isFile())throw new IOException("Workspace Patch Pack устарел после изменения файла; подготовьте его заново");}
