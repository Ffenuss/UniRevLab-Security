...
public class TargetPreparationService extends Service {
    ...
    private void clearTargetDependentOutputs(){
        String[] names={
                ...
                "artifact-families.json","embedded-analysis.json","automatic-evidence.json","automod-plan.json","runtime-session.json","runtime-correlation.json","lua-deep.json","hermes-deep","hermes-deep.json",
