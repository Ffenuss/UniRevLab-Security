...
public class TargetPreparationService extends Service {
    ...
    private void clearTargetDependentOutputs(){String[] names={
            ...
            "il2cpp-crosscheck.json","il2cpp-crosscheck.methods.jsonl","il2cpp-metadata-identity.json","il2cpp-metadata-identity.methods.jsonl","il2cpp-no-rva-native.json","il2cpp-no-rva-native.methods.jsonl",
            ...
            "installed-apk-set.zip","installed-scan.json","metadata.bin","library.so","analysis.json","analysis.summary.json","analysis.methods.jsonl","analysis.fields.jsonl","analysis.evidence-graph.jsonl",
            "analysis.gameplay-coverage.json","analysis-deep","re-analysis.json","re-analysis.ui.json","re-analysis.menu.json","security-surfaces.json","simple-catalog.json","simple-progress.json","rodroid","menu-spec.json","menu-preflight.json","connected-report.json","connected-report.md"};for(String name:names)deleteTree(app.file(name));}
