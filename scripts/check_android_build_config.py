...
checks = [
    ...
    ("v0.29.0 preview versionCode", app, r"versionCode\s*=\s*40"),
    ("v0.29.0 preview versionName", app, r'versionName\s*=\s*"0\.29\.0-preview"'),
    ...
    ("CI APK SHA-256", workflow, r'sha256sum .*UniRevLab-Security-v0\.29\.0-preview'),
    ("CI artifact upload", workflow, r'actions/upload-artifact@v4'),
    ("CI project-history migration", workflow, r'apply_v0290_projects_history\.py'),
]
