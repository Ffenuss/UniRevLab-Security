...
checks = [
    ...
    ("v0.40 preview versionCode", app, r"versionCode\s*=\s*53"),
    ("v0.40 trustworthy-report versionName", app, r'versionName\s*=\s*"0\.40\.0-preview-trustworthy-report"'),
    ...
    ("CI APK SHA-256", workflow, r'sha256sum .*UniRevLab-Security-v0\.40\.0-trustworthy-report-debug\.apk'),
    ...
    ("analysis cache invalidated for v0.40", inspector, r'ENGINE_VERSION\s*=\s*"0\.40\.0-trustworthy-report"'),
