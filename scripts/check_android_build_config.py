...
checks = [
    ...
    ("v0.39 preview versionCode", app, r"versionCode\s*=\s*52"),
    ("v0.39 readable-offset versionName", app, r'versionName\s*=\s*"0\.39\.0-preview-readable-offsets"'),
    ...
    ("CI APK SHA-256", workflow, r'sha256sum .*UniRevLab-Security-v0\.39\.0-readable-offsets-debug\.apk'),
    ...
    ("analysis cache invalidated for v0.39", inspector, r'ENGINE_VERSION\s*=\s*"0\.39\.0-readable-offsets"'),
