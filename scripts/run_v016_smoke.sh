...
OUT="${TMPDIR:-/tmp}/unirevlab-v016-smoke"
...
kotlinc \
  ...
  "$ROOT/app/src/main/java/org/unirevlab/security/analysis/GhidraResultIntegrator.kt" \
  ...
  "$ROOT/test-corpus/smoke/V016StructuralNativeResourceSmoke.kt" \
  -include-runtime -d "$OUT/v016.jar"
java -jar "$OUT/v016.jar" "$ROOT" "$OUT"
