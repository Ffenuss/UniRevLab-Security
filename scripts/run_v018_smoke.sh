...
OUT="${TMPDIR:-/tmp}/unirevlab-v018-smoke"
...
kotlinc \
  ...
  "$ROOT/app/src/main/java/org/unirevlab/security/analysis/ManifestDexReachabilityAnalyzer.kt" \
  ...
  "$ROOT/test-corpus/smoke/V018ReachabilityResourceChainSmoke.kt" \
  -include-runtime -d "$OUT/v018.jar"
java -jar "$OUT/v018.jar" "$ROOT" "$OUT"
